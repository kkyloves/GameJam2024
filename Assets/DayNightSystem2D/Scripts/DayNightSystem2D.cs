...
{
    [Header("Controllers")] [Tooltip("Global light 2D component, we need to use this object to place light in all map objects")]
    ...
    [Header("Cycle Colors")] [Tooltip("Sunrise color, you can adjust based on best color for this cycle")]
    ...
    [Header("Objects")] [Tooltip("Objects to turn on and off based on day night cycles, you can use this example for create some custom stuffs")]
    ...
    private void Update()
    {
        ...
        if (!WaveController.Instance.IsCrimsonEclipseDay())
        {
            // Update cycle time
